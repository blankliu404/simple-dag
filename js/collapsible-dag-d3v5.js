    ...
    try {
      ...
      linkData.forEach((link) => {
        if (
          ...
          const sourceX = link.source.x !== undefined ? link.source.x + this.options.nodeWidth / 2 : 0;
          const sourceY = link.source.y !== undefined ? link.source.y : 0;
          const targetX = link.target.x !== undefined ? link.target.x - this.options.nodeWidth / 2 : 100;
